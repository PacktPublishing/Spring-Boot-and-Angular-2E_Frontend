...
describe('BookList', () => {
  ...
  describe('User Interactions', () => {
    ...
    it('should call editBook with the correct book for every row', () => {
      ...
      mockBooks.forEach((book) => expect(component.editBook).toHaveBeenCalledWith(book));
    });
    ...
    it('should call deleteBook with the correct book for every row', () => {
      ...
      mockBooks.forEach((book) => expect(component.deleteBook).toHaveBeenCalledWith(book));
    });
  });
